...
/**
 * The one place this package decodes a billable's provenance columns.
 *
 ...
 *
 * These four readers were `protected` methods on {@see
 * \FlutterSdk\MagicStarter\Actions\WriteEntitlement}, which is where the rule
 ...
 * `?CarbonInterface` parameter is a TypeError on a payment path.
 *
